...
# Module 8 Lab Guide
[Lab Introduction Video](https://boisestate.hosted.panopto.com/Panopto/Pages/Viewer.aspx?id=c8bd32c4-f58c-4997-b520-b00f01818bb2)  
...
[Walkthrough Video](https://boisestate.hosted.panopto.com/Panopto/Pages/Viewer.aspx?pid=73cdfa6f-270e-4b04-9db4-b012017d24e8)  
...
#### Expected format for PrintInvoice() output
```
...
#### Expected format for PrintDescriptions() output
```
John Doe's Shopping Cart - February 1, 2016
